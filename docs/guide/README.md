...
> Custom domain apps — **Project Management**, **Fitness Coach** (Lifestyle), and
> **KeyVault** tiles — are bespoke and intentionally **not** documented here; this guide
> covers the reusable *platform*.
...
- **Operations & observability** — Workflow Runs, Audit Dashboard, System Logs, System
  Cognition, Productivity.
- **Administration** — **AI Workbench** (the hub below), Mail Settings, Notification
  Recipients, Application Settings, PDF Templates, Shell Console.
